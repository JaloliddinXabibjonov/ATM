...
class BankResourceIT {
    ...
    void createBank() throws Exception {
        ...
        restBankMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(bank))
            )
    ...
    void putWithMissingIdPathParamBank() throws Exception {
        ...
        restBankMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(bank))
            )
