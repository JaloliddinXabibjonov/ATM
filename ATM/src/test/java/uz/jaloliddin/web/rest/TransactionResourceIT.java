...
class TransactionResourceIT {
    ...
    private static final TypeOfPractice DEFAULT_TYPE = TypeOfPractice.DEBIT;
    private static final TypeOfPractice UPDATED_TYPE = TypeOfPractice.CREDIT;
    ...
    void putNewTransaction() throws Exception {
        ...
        updatedTransaction.type(UPDATED_TYPE).amount(UPDATED_AMOUNT).currency(UPDATED_CURRENCY).cardNumber(UPDATED_CARD_NUMBER);
    ...
    void fullUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.type(UPDATED_TYPE).amount(UPDATED_AMOUNT).currency(UPDATED_CURRENCY).cardNumber(UPDATED_CARD_NUMBER);
