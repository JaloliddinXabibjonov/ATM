...
import uz.jaloliddin.repository.TransactionRepository;
import uz.jaloliddin.service.TransactionService;
...
/**
 * REST controller for managing {@link uz.jaloliddin.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
